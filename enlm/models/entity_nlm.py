...
from enlm.modules import DynamicEmbedding
from enlm.training.metrics import Perplexity, UnknownPenalizedPerplexity
...
class EntityNLM(Model):
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        return {
                'ppl': self._perplexity.get_metric(reset).item(),
